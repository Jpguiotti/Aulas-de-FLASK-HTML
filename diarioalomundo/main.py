from flask import Flask, render_template, request # inserido o parametro 'request'.
# from markupsafe import escape - Deletada por não ser utilizada.
...
@app.route('/novoaluno', methods=['POST']) # Rota para inserir novo aluno
def inserir_aluno():
    ra = request.form['ra']
